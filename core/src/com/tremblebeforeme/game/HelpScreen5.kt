...
class HelpScreen5(internal var game: TrembleBeforeMe, var scoreListener: IScores) : ScreenAdapter() {
    ...
    private val TEXT_FIRST_LINE = "ALSO WATCH OUT FOR LAVA!"
    private val TEXT_SECOND_LINE = "EVERY 30 SECONDS LAVA"
    private val TEXT_THIRD_LINE = "APPEARS! DON'T TOUCH IT!"
    ...
    init {
        ...
        touchPoint = Vector3()
        helpImage = Assets.loadTexture("help5.jpg")
    ...
    fun update() {
        if (Gdx.input.justTouched()) {
            ...
            if (nextBounds.contains(touchPoint.x, touchPoint.y)) {
                game.screen = HelpScreen6(game, scoreListener)
            }
        }
    }
