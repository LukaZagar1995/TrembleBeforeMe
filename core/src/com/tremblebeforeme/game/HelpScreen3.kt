...
class HelpScreen3(internal var game: TrembleBeforeMe, var scoreListener: IScores) : ScreenAdapter() {
    ...
    private val TEXT_FIRST_LINE = "AS YOUR SCORE GROWS"
    private val TEXT_SECOND_LINE = "SO DOES AVATARS SPEED"
    ...
    init {
        ...
        touchPoint = Vector3()
        helpImage = Assets.loadTexture("help3.jpg")
    ...
    fun update() {
        if (Gdx.input.justTouched()) {
            ...
            if (nextBounds.contains(touchPoint.x, touchPoint.y)) {
                game.screen = HelpScreen4(game, scoreListener)
            }
        }
    }
