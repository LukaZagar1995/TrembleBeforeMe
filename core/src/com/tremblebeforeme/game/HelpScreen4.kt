...
class HelpScreen4(internal var game: TrembleBeforeMe, var scoreListener: IScores) : ScreenAdapter() {
    ...
    private val TEXT_FIRST_LINE = "BUT BE CAREFUL, IF YOUR"
    private val TEXT_SECOND_LINE = "AVATAR TOUCHES SPIKES"
    private val TEXT_THIRD_LINE = "YOUR SCORE GOES DOWN"
    ...
    init {
        ...
        touchPoint = Vector3()
        helpImage = Assets.loadTexture("help4.jpg")
    ...
    fun update() {
        if (Gdx.input.justTouched()) {
            ...
            if (nextBounds.contains(touchPoint.x, touchPoint.y)) {
                game.screen = HelpScreen5(game, scoreListener)
            }
        }
    }
